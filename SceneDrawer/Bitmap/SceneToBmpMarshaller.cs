namespace SceneDrawer.Bitmap {
	public class BitmapToBmpMarshaller {
		...
		public void MarshallScene(Scene scene, BmpSceneBitmap bm, string path) {
			using (FileStream fs = new FileStream(path, FileMode.OpenOrCreate)) {
				MarshallScene(scene, bm, fs);
			}
		}

		public void MarshallScene(Scene scene, BmpSceneBitmap bm, FileStream oStream) {
